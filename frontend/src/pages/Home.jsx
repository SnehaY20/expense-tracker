...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#060B22] via-[#0E2D54] to-[#4A2F4E] text-white overflow-hidden relative">
    <AnimatedBackground />
      <Navbar />

      <section className="relative z-10 px-6 pt-32 py-20">
